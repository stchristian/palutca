export const messages = {
  ...
  notificationSuccessfullySetUp:
    "The setup was successful. The notifications will appear in this chat conversation. ",
  notificationRemovedSuccessfully: "Successfully removed notification",
  notificationStoppedSuccessfully:
    "Successfully stopped notification. You can resume it later if you want",
